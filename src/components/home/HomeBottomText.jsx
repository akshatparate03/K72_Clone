...
const HomeBottomText = () => {
  return (
    <div className="font-[font2] flex items-center justify-center gap-2 ">
      <p className="absolute lg:w-[24vw] w-70 lg:right-20 right-0 bottom-52  lg:bottom-50 font-[font1] lg:text-xs text-s lg:leading-relaxed leading-tight">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div className="lg:border-2 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-30 h-15 flex items-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase">
